...
function cambiarHTML (numerodeti) {//declaran la función en la vamos a mostrar el texto 
    ...
    if (resultadovalidacion === true ){
       ...
       campoformulario.innerHTML= "Hola " + nombre + " tu número de tarjeta finalizada en " + stringmaskif + " con fecha de vencimiento " + fechaven  + " es " + resultadovalidacion;
    } else {
...
//     resultadovalidacion = "invalida";
//     campoformulario.innerHTML=  " Tu tarjeta es  " + resultadovalidacion + " por favor ingresa de nuevo ";//imprimiendo el mensjaes con los datos
//    }else {
//    resultadovalidacion = "valida"
   
//    campoformulario.innerHTML= "Hola " + nombre + " tu número de tarjeta finalizada en " + stringmaskif + " con fecha de vencimiento " + fechaven  + " es " + resultadovalidacion;//imprimiendo el mensjaes 
// }
